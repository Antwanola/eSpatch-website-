            ...
            <FooterMargin>
                <Box borderBottom={'1px solid gray'}>
                    ...
                    >
                        ...
                        <NextLink href="/contact#partner-form" style={{ textDecoration: 'none' }}>
                            <Button
                ...
                >
                    <Box width={{ base: '100%', md: '25%' }} >
                        ...
                        <Flex mt={6} gap={3}>
                            <ChakraLink href='#' bg={'#6b7e901d'} border={'1px ridge gray'} p={2} color={'gray'} borderRadius={10} _hover={{ color: 'button' }}><FaLinkedinIn /></ChakraLink>
                            <ChakraLink href='#' bg={'#6b7e901d'} border={'1px ridge gray'} p={2} color={'gray'} borderRadius={10} _hover={{ color: 'button' }}><BsTwitterX /></ChakraLink>
                            <ChakraLink href='#' bg={'#6b7e901d'} border={'1px ridge gray'} p={2} color={'gray'} borderRadius={10} _hover={{ color: 'button' }}><FaInstagram /></ChakraLink>
                        </Flex>
                    </Box>
                    ...
                    <Box width={{ base: '100%', sm: '45%', md: 'auto' }} >
                        ...
                        <Flex direction="column" gap={3}>
                            <ChakraLink color={'gray'} _hover={{ color: 'button' }} href="#" fontSize={'sm'} display="flex" alignItems="center" gap={2}>
                    ...
                    <Box width={{ base: '100%', sm: '100%', md: 'auto' }}>
                        ...
                        <Flex direction="column" gap={3}>
                            <ChakraLink color={'gray'} _hover={{ color: 'button' }} href="#" fontSize={'sm'} display="flex" alignItems="start" gap={2}>
